...
export class AuthService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public authControllerCreateStudent(body: CreateUserDto, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public authControllerCreateStudent(body: CreateUserDto, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public authControllerCreateStudent(body: CreateUserDto, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public authControllerCreateStudent(body: CreateUserDto, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling authControllerCreateStudent.');
        }
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/auth/create-student`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
