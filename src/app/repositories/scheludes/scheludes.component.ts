...
//       this.sub$.add(
//         this.schedulesService
//           .getSchedules$({ sectionId: this.sectionId, periodId: this.periodId })
//           .subscribe((schedules) => {
//             this.scheludeData = {
//               ...this.scheludeData,
//               body: schedules || [],
...
//       if (departmentId) {
//         lastDepartment = (
//           await lastValueFrom(this.schedulesService.getDepartaments$({
...
//             lastSubject = (
//               await lastValueFrom(
//                 this.schedulesService.getSubjects$({departmentId: +departmentId, semester: +semesterId})
//               )
//             ).find((subj) => subj.id == +subjectId);
//             if (subjectId) {
//               lastSection = (
//                 await lastValueFrom(
//                   this.schedulesService.getSections$({subjectId: +subjectId, periodId: this.periodId})
//                 )
